-- Replaces the ingress routine after the first Preview application.
--
-- A Supabase Preview Branch keeps an already-applied migration immutable.
-- Keeping this replacement as an explicit forward migration makes both an
-- existing Preview and a fresh database converge on the same routine body.
